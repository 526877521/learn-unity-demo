...
namespace XFramework.ExcelData.Editor
{
    public static class ExcelConvertPathSetting
    {
        ...
        /// 代码生成路径
        /// </summary>
        public const string GenerateCSFilePath = "/Assets/3rd/ExcelDataTool/HotUpdateScripts/Game/ExcelData/";

        /// <summary>
        /// asset数据生成路径
        /// </summary>
        public const string ASSET_OUTPUT_PATH = "/3rd/ExcelDataTool/HotUpdateResources/ExcelData/";
        public const string Excel_ROOT_PATH = "Assets/3rd/ExcelDataTool/Excel";
        ...
        public static string GetExcelGenerateCSFilePath()
        {
            ...
            Debug.Log("hotfixPath="+hotfixPath);
            return hotfixPath;
        }
